...
<div class="pb-posts">
<a class="pb-post-card" href="production-stack-readiness-gap/" data-tags="Serving,Distributed">
<span class="pb-post-image pb-image-contain"><img src="/assets/blog/production-stack-readiness.svg" alt="KV-aware router 的健康檢查與 LLM request path" width="579" height="702" loading="eager" fetchpriority="high" decoding="async"><span class="pb-image-credit">Measured lab path</span></span>
<span class="pb-post-body">
<span class="pb-post-title">177/177 Healthy, 3/12 Complete｜LLM readiness gap</span>
<span class="pb-post-tags"><span class="pb-tag pb-tag-green">Serving</span><span class="pb-tag pb-tag-blue">Kubernetes</span><span class="pb-tag pb-tag-red">Reliability</span></span>
<span class="pb-post-excerpt">Event loop 修好後，健康檢查全綠，request completion 卻仍失敗；拆開 tokenizer concurrency、backend warm-up 與 readiness gates。</span>
<span class="pb-post-date">2026-07-29</span>
</span>
</a>
